...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      'fixed inset-0 z-50 bg-dark-300/70 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      className
    )}
    {...props}
    ref={ref}
...
>(({ side = 'right', className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn('w-72 flex flex-col', sheetVariants({ side }), className)}
      {...props}
    >
      {children}
    </SheetPrimitive.Content>
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      'h-16 flex justify-between items-center flex-wrap border-b px-4',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description
    ref={ref}
    className={cn('text-muted font-light', className)}
    {...props}
  />
))
